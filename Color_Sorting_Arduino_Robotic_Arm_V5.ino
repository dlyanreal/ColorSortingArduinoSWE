...
// sort colors into appropriate bins, progressively closer to the base of the arm
  if (color == "RED") {
    if (red_count < 13) {
      binIndex = 0;
      red_count +=1;
      joint1_target = 90 - (red_count*3);
      joint2_target = 80 + (red_count*8);
    } else {
    ...
    if (green_count < 13) {
      binIndex = 1;
      green_count += 1;
      joint1_target = 90 - (green_count*3);
      joint2_target = 80 + (green_count*8);
    } else {
    ...
    if (blue_count < 13) {
      binIndex = 2;
      blue_count += 1;
      joint1_target = 90 - (blue_count*3);
      joint2_target = 80 + (blue_count*8);
    } else {
    ...
    if (undefined_count < 13) {
      binIndex = 3;
      undefined_count += 1;
      joint1_target = 90 - (undefined_count*3);
      joint2_target = 80 + (undefined_count*8);
    } else {
